...
#main
def games():
	global bonus,score,surf,direction,change_to,head_position
	...
	while True:
		...
		if collision(h1, head_position, apple, fruit_position)==True or collision(h2, head_position, buff, fruit_position):
			eat()
			fruit_spawn = False
